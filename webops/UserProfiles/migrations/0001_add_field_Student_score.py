...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.score'
        db.add_column('UserProfiles_student', 'score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.score'
        db.delete_column('UserProfiles_student', 'score')
    ...
    models = {
        'UserProfiles.student': {
            ...
            'writeup': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'auth.group': {
